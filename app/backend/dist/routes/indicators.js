...
exports.default = indicatorsRoutes;
const db_1 = __importDefault(require("../db"));
async function indicatorsRoutes(fastify) {
    ...
    fastify.post('/indicators', async (request, reply) => {
        const { codigo, nome, setor, meta, periodicidade } = request.body;
        const client = await db_1.default.connect();
        try {
    ...
    fastify.post('/indicators/:id/coletas', async (request, reply) => {
        ...
        const { data_coleta, valor, responsavel, observacao } = request.body;
        const client = await db_1.default.connect();
        try {
